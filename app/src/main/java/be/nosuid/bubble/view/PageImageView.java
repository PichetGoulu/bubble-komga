...
public class PageImageView extends AppCompatImageView {
    private SettingsManager.PageViewMode mViewMode;
    ...
    public void setViewMode(SettingsManager.PageViewMode viewMode, boolean isLeftToRight) {
        mViewMode = viewMode;
        mTranslateRightEdge = !isLeftToRight
                && (mViewMode == SettingsManager.PageViewMode.ASPECT_FILL);
        mSkipScaling = false;
        requestLayout();
        invalidate();
    ...
    private void init() {
        ...
        mViewMode = SettingsManager.PageViewMode.ASPECT_FIT;
    }
    ...
    private void scale() {
        ...
        if (mViewMode == SettingsManager.PageViewMode.ASPECT_FILL) {
            float scale;
            float dx = 0;
        ...
        } else if (mViewMode == SettingsManager.PageViewMode.ASPECT_FIT) {
        ...
        } else if (mViewMode == SettingsManager.PageViewMode.FIT_WIDTH) {
